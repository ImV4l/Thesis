            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table id="myTable" class="table table-bordered">
                        ...
                        <tbody>
                            <?php
                            // Modified query to fetch only users (role_as = 0)
                            $query = "SELECT * FROM admin WHERE status!='2' AND role_as='0'";
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?= $row['username']; ?></td>
                                        <td><?= $row['email']; ?></td>
                                        <td>User</td> <!-- Hardcoded as User since we're only fetching users -->
                                        <td>
                                            <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#updateModal"
                                                ...
                                                data-role="0"> <!-- Set role to 0 for users -->
                                                Update
                                            </button>

...
// Query to get office attendance data
...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Office Attendance</h1>
            ...
            <div class="row">
                <?php if(mysqli_num_rows($result_office) > 0): ?>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body text-center">
                                ...
                                <h5 class="text-muted">No Office Data Available</h5>
                                <p class="text-muted">There are currently no office attendance records to display.</p>
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5><i class="fas fa-chart-bar me-2"></i>Office Attendance Summary</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="text-center">
                                        <h4 class="text-primary"><?php echo mysqli_num_rows($result_office); ?></h4>
                                        <p class="text-muted">Total Offices</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="text-center">
                                ...
                                <div class="col-md-4">
                                    <div class="text-center">
                                        ...
                                        $today_query = "SELECT COUNT(DISTINCT a.sa_id) as today_sa 
                                                       ...
                                                       INNER JOIN student_assistant sa ON a.sa_id = sa.id 
                                                       INNER JOIN work w ON sa.work LIKE CONCAT('%', w.work_name, '%') 
                                                       WHERE w.type = 'Office' AND a.date = CURDATE()";
